...
type GaleraBackupLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta2.GaleraBackup, err error)
...
// List lists all GaleraBackups in the indexer.
func (s *galeraBackupLister) List(selector labels.Selector) (ret []*v1beta2.GaleraBackup, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta2.GaleraBackup))
	})
	return ret, err
}
...
type GaleraBackupNamespaceLister interface {
	...
	Get(name string) (*v1beta2.GaleraBackup, error)
...
// List lists all GaleraBackups in the indexer for a given namespace.
func (s galeraBackupNamespaceLister) List(selector labels.Selector) (ret []*v1beta2.GaleraBackup, err error) {
...
// Get retrieves the GaleraBackup from the indexer for a given namespace and name.
func (s galeraBackupNamespaceLister) Get(name string) (*v1beta2.GaleraBackup, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta2.Resource("galerabackup"), name)
	}
	return obj.(*v1beta2.GaleraBackup), nil
}
